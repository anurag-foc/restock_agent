...
- **What it is:** `Restockify - Supervisor Agent`, created via the Databricks SDK's `w.supervisor_agents` service (endpoint name changes across re-creations — kept in sync automatically, see §2.5 step 5).
